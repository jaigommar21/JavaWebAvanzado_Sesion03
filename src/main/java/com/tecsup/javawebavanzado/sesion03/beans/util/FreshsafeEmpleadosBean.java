package com.tecsup.javawebavanzado.sesion03.beans.util;
...
@ManagedBean(name = "freshsafeEmpleadosBean")
@SessionScoped
public class FreshsafeEmpleadosBean implements Serializable {
